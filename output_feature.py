...
class love_language:
    ...
    def physical_touch(self):
        ...
        suggestion = random.choice(physical_touch)
        return suggestion

    def quality_time(self):
        quality_time = [
        ...
        suggestion = random.choice(quality_time)
        return suggestion

    def acts_of_service(self):
        acts_of_service = [
        ...
        suggestion = random.choice(acts_of_service)
        return suggestion

    def gift_giving(self):
        gift_giving = [
        ...
        suggestion = random.choice(gift_giving)
        return suggestion
